		    		...
		    		<div align="center" style="min-height: 32px;">
		    			<div class="clearfix">
							<div class="btn-group inline pull-left" id="texteditor" style="display:none">						  
								<button id="font-family" class="btn dropdown-toggle" data-toggle="dropdown" title="Font Style"><i class="glyphicon glyphicon-font" style="width:19px;height:19px;"></i></button>		                      
							    ...
							    <button id="text-bold" class="btn" data-original-title="Bold"><i class="glyphicon glyphicon-bold"></i></button>
							    <button id="text-italic" class="btn" data-original-title="Italic"><i class="glyphicon glyphicon-italic"></i></button>


<!--                            Rayé et souligné le texte-->
<!--
							    <button id="text-strike" class="btn" title="Strike" style=""><img src="<?//= $this->assetUrl('img/custom/font_strikethrough.png') ?>" height="" width=""></button>
							 	<button id="text-underline" class="btn" title="Underline" style=""><img src="<?//= $this->assetUrl('img/custom/font_underline.png') ?>"></button>
-->
<!--                            Couleur du texte et couleur de bordure de texte-->
<!--
